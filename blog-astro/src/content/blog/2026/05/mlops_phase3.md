...
<p style="text-align: center; font-size: 0.875rem; color: #6b7280;">圖1 ▲ 資料進入模型前的物理形態：Batch Size × Seq Length 的 2D Tensor，input_ids 存 token ID，attention_mask 標記真實 token（1）與 padding（0）</p>
