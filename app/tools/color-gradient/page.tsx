      ...
      <div className="mt-6 bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-wrap items-end gap-3 mb-3 text-sm">
          <div>
            ...
            <input type="number" value={outWidth} onChange={(e) => setOutWidth(Number(e.target.value))} className="w-28 px-2 py-1 border rounded" />
          </div>
          <div>
            <label className="block mb-1">高度</label>
            <input type="number" value={outHeight} onChange={(e) => setOutHeight(Number(e.target.value))} className="w-28 px-2 py-1 border rounded" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="number" value={dpi} onChange={(e) => setDpi(Number(e.target.value))} className="w-24 px-2 py-1 border rounded" />
          </div>
          <button
