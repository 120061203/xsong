    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div id="personal-info" className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 mx-4 sm:mx-8 lg:mx-12">
            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-4 h-4 bg-blue-500 rounded-full mt-1.5"></div>
                  <div className="ml-6 flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">COSCUP開源人年會</h3>
                    <span className="inline-block px-3 py-1 text-sm bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded-full mb-3">2023 - 2025</span>
                    <p className="text-gray-600 dark:text-gray-400 mb-2">製播組成員</p>
              ...
              <div className="relative">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-4 h-4 bg-green-500 rounded-full mt-1.5"></div>
                  <div className="ml-6 flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Google Developer Groups On Campus</h3>
                    <span className="inline-block px-3 py-1 text-sm bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 rounded-full mb-3">2023 - 2024</span>
                    <p className="text-gray-600 dark:text-gray-400 mb-2">Organizer</p>
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                      籌備規劃協調各活動，接洽講師，推動校園技術社群發展。
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 rounded">活動籌備</span>
                      <span className="px-2 py-1 text-xs bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 rounded">講師接洽</span>
                      <span className="px-2 py-1 text-xs bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 rounded">社群發展</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-4 h-4 bg-red-500 rounded-full mt-1.5"></div>
                  <div className="ml-6 flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">HITCON台灣駭客年會</h3>
                    <span className="inline-block px-3 py-1 text-sm bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-300 rounded-full mb-3">2024</span>
                    <p className="text-gray-600 dark:text-gray-400 mb-2">場務組</p>
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                      負責物品搬運、各議程人員管控，確保駭客年會活動順利進行。
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-300 rounded">物品搬運</span>
                      <span className="px-2 py-1 text-xs bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-300 rounded">人員管控</span>
                      <span className="px-2 py-1 text-xs bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-300 rounded">駭客年會</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-4 h-4 bg-purple-500 rounded-full mt-1.5"></div>
                  <div className="ml-6 flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">SITCON學生計算機年會</h3>
                    <span className="inline-block px-3 py-1 text-sm bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300 rounded-full mb-3">2022.12</span>
                    <div className="mb-2">
                      <p className="text-gray-600 dark:text-gray-400">HoC 助教</p>
                      <p className="text-gray-600 dark:text-gray-400">Camp 記錄組</p>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                      擔任 Hour of Code 助教協助學員學習程式設計，並負責平面攝影和後製出圖，記錄學生技術交流的重要時刻。
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300 rounded">HoC 助教</span>
                      <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300 rounded">平面攝影</span>
                      <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300 rounded">後製出圖</span>
                      <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300 rounded">學生社群</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* 聯絡方式 */}
          <div id="contact" className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <a href="https://github.com/120061203" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
                      github.com/120061203
                    </a>
                    <button 
                      onClick={async (e) => {
                        const btn = e.currentTarget as HTMLButtonElement;
                        ...
                        try {
                          await navigator.clipboard.writeText('https://github.com/120061203');
                        } catch (err) {
                          console.error('複製失敗:', err);
                          const textArea = document.createElement('textarea');
                          textArea.value = 'https://github.com/120061203';
                          document.body.appendChild(textArea);
                          textArea.select();
                          document.execCommand('copy');
                          document.body.removeChild(textArea);
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <a href="https://linkedin.com/in/songlinchen" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
                      linkedin.com/in/songlinchen
                    </a>
                    <button 
                      onClick={async (e) => {
                        const btn = e.currentTarget as HTMLButtonElement;
                        ...
                        try {
                          await navigator.clipboard.writeText('https://linkedin.com/in/songlinchen');
                        } catch (err) {
                          console.error('複製失敗:', err);
                          const textArea = document.createElement('textarea');
                          textArea.value = 'https://linkedin.com/in/songlinchen';
                          document.body.appendChild(textArea);
                          textArea.select();
                          document.execCommand('copy');
                          document.body.removeChild(textArea);
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <a href="https://instagram.com/c.s.l.0922" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
                      instagram.com/c.s.l.0922
                    </a>
                    <button 
                      onClick={async (e) => {
                        const btn = e.currentTarget as HTMLButtonElement;
                        ...
                        try {
                          await navigator.clipboard.writeText('https://instagram.com/c.s.l.0922');
                        } catch (err) {
                          console.error('複製失敗:', err);
                          const textArea = document.createElement('textarea');
                          textArea.value = 'https://instagram.com/c.s.l.0922';
                          document.body.appendChild(textArea);
                          textArea.select();
                          document.execCommand('copy');
                          document.body.removeChild(textArea);
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-40">
        <div className="flex flex-col gap-2 sm:gap-3">
          ...
          <button
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group"
          >
          ...
          <button
            onClick={() => scrollToSection('contact')}
            className="w-10 h-10 sm:w-12 sm:h-12 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group"
          >
            <svg className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          ...
          {/* YouTube 頻道按鈕 */}
          <a
            href="https://www.youtube.com/@xiaosong4456"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 sm:w-12 sm:h-12 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group"
