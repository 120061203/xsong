              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Google Developer Groups On Campus</h3>
                  </div>
                  <span className="text-sm text-gray-500 dark:text-gray-400">2023 - 2024</span>
                </div>
                <p className="text-gray-600 dark:text-gray-400 mb-3">Organizer</p>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  籌備規劃協調各活動，接洽講師，推動校園技術社群發展。
                </p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded">活動籌備</span>
                  <span className="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded">講師接洽</span>
                  <span className="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded">社群發展</span>
                </div>
              </div>
            </div>
          </div>
