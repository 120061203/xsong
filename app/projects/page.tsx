...
const projects: Project[] = [
  {
    ...
    technologies: ['AI', 'Claude API', 'Sonnet 4.6', 'FastAPI', 'Python', 'SSE', 'Multi-Agent', 'Tool Use', 'Extended Thinking', 'DuckDuckGo Search', 'Anthropic SDK'],
  ...
  },
  {
    ...
    pdfUrl: 'https://github.com/120061203/xsong/raw/main/public/songlinchen_20260627.pdf',
