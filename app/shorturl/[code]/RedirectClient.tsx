...
export default function RedirectClient({ code }: { code: string }) {
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <a
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 dark:bg-green-400 hover:bg-blue-700 dark:hover:bg-green-700 transition-colors"
          >
            前往網址
          </a>
        </div>
